...
#if 0
std::tuple<size_t, std::unique_ptr<char[]>> construct(PacketSsl* cipher, char* metadata, size_t meta_sz, char* data, size_t data_sz) {
...
std::unique_ptr<uint8_t[]>  destruct(PacketSsl* cipher, char* enc_data, size_t enc_sz) {
